...
const coachesModule = {
	...
	actions: {
		async addCoach(context, payload) {
			...
			await axios
				.put(`https://coach-is-here-2dfdb-default-rtdb.firebaseio.com/coaches/${userId}.json?auth=` + token, coachData)
				.then((res) => {
					console.log(res)
				})
				.catch((err) => {
		...
		async loadCoaches(context, payload) {
			...
			await axios
				.get(`https://coach-is-here-2dfdb-default-rtdb.firebaseio.com/coaches.json`)
				.then((res) => {
					let data = res.data
					let coaches = []

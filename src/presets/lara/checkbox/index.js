export default {
	...
	box: ({ props, context }) => ({
		class: [
			...
			// Colors
			{
				'border-purple-200 bg-purple-0 dark:border-purple-50 dark:bg-purple-50': !context.checked,
				'border-purple-50 bg-purple-700 dark:border-purple-50 dark:bg-purple-600': context.checked,
			},

export default {
	...
	input: ({ props }) => ({
		class: [
			...
			'bg-purple-50 dark:bg-purple-200',
	...
	inputicon: {
		class: ['absolute top-[50%] -mt-2', 'text-white dark:text-surface-200', 'right-[.75rem]'],
	},
	dropdownbutton: {
		root: {
			class: [
	...
	panel: ({ props }) => ({
		class: [
			...
			// Colors
			'bg-purple-500 dark:bg-surface-800',
	...
	datepickerMask: {
		class: ['fixed top-0 left-0 w-full h-full', 'flex items-center justify-center', 'bg-purple-50 bg-opacity-90'],
	},
	header: {
		class: [
			//Font
	...
	previousbutton: {
		class: [
			...
			// States
			'hover:text-white dark:hover:text-white/80',
	...
	weekheader: {
		class: ['leading-5', 'text-white dark:text-white/70', 'opacity-60 cursor-default'],
	},
	weeknumber: {
		class: ['text-white dark:text-white/70', 'opacity-60 cursor-default'],
	},
	weekday: {
		class: [
			// Colors
	...
	weeklabelcontainer: ({ context }) => ({
		class: [
			...
			// Colors
			{
				'text-white dark:text-white/70 bg-transparent': !context.selected && !context.disabled,
	...
	daylabel: ({ context }) => ({
		class: [
			...
			// Colors
			{
				'text-white dark:text-white': context.date.today,
				'text-white dark:text-white/70 bg-transparent': !context.selected && !context.disabled && !context.date.today,
